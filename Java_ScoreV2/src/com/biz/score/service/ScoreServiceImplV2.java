 ...
 * = inherit :상속받다
 * 같은 의미로 씀
 * V1에 있는 기능을 V2가 받아서 사용하겠다
 * 
 * 자바에서 클래스 상속
 * 자바 객체지향 개념에서 가장 중요한 개념
 * 기존에 잘 만들어진 클래스를 상속받아서 (inherit) 그 중 일부 method를
 * 나만의 코드로 바꾸어서 사용하고 싶을 때 클래스를 확장하여 (extends) 참조하고
 * 필요한 method를 재정의 (override)하여 사용한다.
 * 
 * overloading
 * 한 클래스 내에서 메서드를 중복하여 쓸 수 있다
 * 매개변수 없는 메서드.. 매개변수가 2개 이거나 5개 이거나
 * 
 */
...
public class ScoreServiceImplV2 extends ScoreServiceImplV1 {
	...
	/*
	 * 이 곳에는 ㄴ보이지는 않지만 ScoreServiceImplV1의 
	 * 모든 기능(필드변수, 메서드)이 복사 붙이기 되어 있는 것과 같다.
	 * extends ScoreServiceImplV1 명령문을 클래스 뒤에 붙였기 때문이다
	 * 
	 * ScoreServiceImplV1의 모든 기능 중 scoreList() method 의 코드를
	 * 바꾸어서 작성하고 싶다.
	 * 단, 나머지 기능은 V1의 것을 사용하고 싶다. 
	 * source- override/implements 사용
	 */ 
