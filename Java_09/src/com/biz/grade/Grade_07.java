...
public class Grade_07 {
	...
	public static void main(String[] args) {
		...
		Student 홍길동 = new Student(); //객체만이 갖는 특징적인 변수설정
		Student 이몽룡 = new Student();
		Student 성춘향 = new Student(); //중요코드
		//내가 만든 student클래스로 찾아간다
		// 변수 앞에 public이 있는지
		
		홍길동.strName = "홍길동"; //student클래스에 public 사용하여 객체.변수이름 =을 저장할 수 있다.
		홍길동.intAge = 38;
		홍길동.strTel = "010-111";
		...
		System.out.println("홍길동 이름 :" +홍길동.getName()); //student 클래스에있는 getname메서드를 호출
