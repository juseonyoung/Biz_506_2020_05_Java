 ...
 * 엑셀은 xls, xlsx 파일 외에 *.csv라는 파일을 읽어서 엑셀 데이터처럼 취급할 수 있는데
 * * .csv파일은 컴마로 데이터들을 구문하는 문자열로 만들고 그 내용을 text 형식으로 저장하면 된다.
 * 
 */
public class ScoreEx_02 {
	...
	public static void main(String[] args) {
		...
		String outFile = "src/com/biz/student/exec/score.csv"; // 컴마를 기준으로..
